...
{
	template<class TKey, class TValue>
	KeyValuePairView<TKey, TValue>::KeyValuePairView(TKey &key, TValue &value)
		: m_key(key)
		, m_value(value)
	{
	}
	...
	template<class TKey, class TValue>
	TKey &KeyValuePairView<TKey, TValue>::Key() const
	{
		return m_key;
	}

	template<class TKey, class TValue>
	TValue &KeyValuePairView<TKey, TValue>::Value() const
	{
		return m_value;
	}

	template<class TKey, class TValue>
	HashMapConstIterator<TKey, TValue>::HashMapConstIterator(const HashMap<TKey, TValue> &hashMap, size_t offset)
		: m_hashMap(hashMap)
		, m_offset(offset)
	{
	}
	...
	template<class TKey, class TValue>
	HashMapConstIterator<TKey, TValue>::HashMapConstIterator(const HashMapIterator<TKey, TValue> &mutableIterator)
	...
	template<class TKey, class TValue>
	const TKey &HashMapConstIterator<TKey, TValue>::Key() const
	{
		EXP_ASSERT(m_offset <= m_hashMap.m_capacity);
		EXP_ASSERT(m_hashMap.m_valueMainPosPlusOne[m_offset] != 0);
		return m_hashMap.m_keys[m_offset];
	}

	template<class TKey, class TValue>
	const TValue &HashMapConstIterator<TKey, TValue>::Value() const
	{
		EXP_ASSERT(m_offset <= m_hashMap.m_capacity);
		EXP_ASSERT(m_hashMap.m_valueMainPosPlusOne[m_offset] != 0);
	...
	template<class TKey, class TValue>
	bool HashMapConstIterator<TKey, TValue>::operator==(const HashMapConstIterator<TKey, TValue> &other) const
	{
	...
	template<class TKey, class TValue>
	KeyValuePairView<const TKey, const TValue> HashMapConstIterator<TKey, TValue>::operator*() const
	{
		EXP_ASSERT(m_offset <= m_hashMap.m_capacity);
		EXP_ASSERT(m_hashMap.m_valueMainPosPlusOne[m_offset] != 0);
	...
	template<class TKey, class TValue>
	HashMapConstIterator<TKey, TValue> &HashMapConstIterator<TKey, TValue>::operator++()
	{
		EXP_ASSERT(m_offset < m_hashMap.m_capacity);
		do
		{
	...
	template<class TKey, class TValue>
	HashMapConstIterator<TKey, TValue> HashMapConstIterator<TKey, TValue>::operator++(int)
	{
		HashMapConstIterator<TKey, TValue> copy(*this);
		++(*this);
		return copy;
	}

	template<class TKey, class TValue>
	HashMapIterator<TKey, TValue>::HashMapIterator(const HashMap<TKey, TValue> &hashMap, size_t offset)
		: m_hashMap(hashMap)
		, m_offset(offset)
	{
	}
	...
	template<class TKey, class TValue>
	const TKey &HashMapIterator<TKey, TValue>::Key() const
	{
		EXP_ASSERT(m_offset <= m_hashMap.m_capacity);
		EXP_ASSERT(m_hashMap.m_valueMainPosPlusOne[m_offset] != 0);
		return m_hashMap.m_keys[m_offset];
	...
	template<class TKey, class TValue>
	TValue &HashMapIterator<TKey, TValue>::Value() const
	{
		EXP_ASSERT(m_offset <= m_hashMap.m_capacity);
		EXP_ASSERT(m_hashMap.m_valueMainPosPlusOne[m_offset] != 0);
		return m_hashMap.m_values[m_offset];
	...
	template<class TKey, class TValue>
	KeyValuePairView<const TKey, TValue> HashMapIterator<TKey, TValue>::operator*() const
	{
		EXP_ASSERT(m_offset <= m_hashMap.m_capacity);
		EXP_ASSERT(m_hashMap.m_valueMainPosPlusOne[m_offset] != 0);
	...
	template<class TKey, class TValue>
	HashMapIterator<TKey, TValue> &HashMapIterator<TKey, TValue>::operator++()
	{
		EXP_ASSERT(m_offset < m_hashMap.m_capacity);
		do
		{
	...
	template<class TKey, class TValue>
	HashMapIterator<TKey, TValue> HashMapIterator<TKey, TValue>::operator++(int)
	{
		HashMapIterator<TKey, TValue> copy(*this);
		++(*this);
		return copy;
	}

	template<class TKey, class TValue>
	HashMap<TKey, TValue>::HashMap(IAllocator &alloc)
		: m_buffer(nullptr)
		, m_alloc(alloc)
		, m_keys(nullptr)
		, m_values(nullptr)
	...
	template<class TKey, class TValue>
	Result HashMap<TKey, TValue>::Insert(const TKey &key, const TValue &value)
	{
	...
	template<class TKey, class TValue>
	Result HashMap<TKey, TValue>::Insert(TKey &&key, const TValue &value)
	{
		CHECK_RV(TValue, clonedValue, Cloner<TValue>::Clone(value));
	...
	template<class TKey, class TValue>
	Result HashMap<TKey, TValue>::Insert(const TKey &key, TValue &&value)
	{
		CHECK_RV(TKey, clonedKey, Cloner<TKey>::Clone(key));
	...
	template<class TKey, class TValue>
	Result HashMap<TKey, TValue>::Insert(TKey &&key, TValue &&value)
	{
		if (m_capacity == 0)
		{
			RKC_CHECK(Rehash(8));
	...
	template<class TKey, class TValue>
	void HashMap<TKey, TValue>::Remove(const HashMapIterator<TKey, TValue> &iterator)
	{
		EXP_ASSERT(this == &iterator.m_hashMap);

		this->RemoveIndex(iterator.m_offset);
	}

	template<class TKey, class TValue>
	void HashMap<TKey, TValue>::RemoveIndex(size_t index)
	{
		EXP_ASSERT(index < m_capacity);
		EXP_ASSERT(m_valueMainPosPlusOne[index] != 0);
	...
	template<class TKey, class TValue>
	HashMapConstIterator<TKey, TValue> HashMap<TKey, TValue>::begin() const
	{
	...
	template<class TKey, class TValue>
	HashMapIterator<TKey, TValue> HashMap<TKey, TValue>::begin()
	{
		for (size_t i = 0; i < m_capacity; i++)
		{
			if (m_valueMainPosPlusOne[i] != 0)
	...
	template<class TKey, class TValue>
	HashMapConstIterator<TKey, TValue> HashMap<TKey, TValue>::end() const
	{
		return HashMapConstIterator<TKey, TValue>(*this, m_capacity);
	}

	template<class TKey, class TValue>
	HashMapIterator<TKey, TValue> HashMap<TKey, TValue>::end()
	{
		return HashMapIterator<TKey, TValue>(*this, m_capacity);
	}

	template<class TKey, class TValue>
	Result HashMap<TKey, TValue>::Rehash(size_t size)
	{
	...
	template<class TKey, class TValue>
	Result HashMap<TKey, TValue>::AutoRehash()
	{
	...
	template<class TKey, class TValue>
	Result HashMap<TKey, TValue>::InsertNew(TKey &&key, TValue &&value, Hash_t keyHash, size_t keyMainPosition, size_t mpValueMPPlusOne, bool mayResize)
	{
	...
	template<class TKey, class TValue>
	template<class TCandidateKey>
	Optional<size_t> HashMap<TKey, TValue>::FindKey(const TCandidateKey &key) const
	{
		if (m_used == 0)
	...
	inline size_t HashMapUtils::GetCompactValue(const size_t *items, CompactValuePrecision cvPrecision, size_t index)
	{
		return items[index];
	}

	inline void HashMapUtils::SetCompactValue(size_t *items, CompactValuePrecision cvPrecision, size_t index, size_t value)
	{
		items[index] = value;
	}

	inline size_t HashMapUtils::GetMainPosition(Hash_t hash, size_t count)
	{
